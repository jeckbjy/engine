...
class OGL_DescriptorSet;
class CUTE_OGL_API OGL_CommandBuffer : public ICommandList
{
public:
	OGL_CommandBuffer();
	~OGL_CommandBuffer();
...
//	void setTopology(Topology topology);
	void setDescriptorSet(IDescriptorSet* descriptors);
...
//	RenderTarget*		m_target;
	...
	OGL_Buffer*			m_index;
	OGL_DescriptorSet*	m_descriptors;
	GLint				m_primitive;
...
//class CUTE_OGL_API OGL_CommandQueue : public ICommandQueue
//{
//public:
