...
#if ! (defined (DOXYGEN) || CUTE_EXCEPTIONS_DISABLED)
...
public:
    ...
    */
    ...
    void swap (HeapBlock<ElementType, otherBlockThrows>& other) noexcept
    {
        std::swap (data, other.data);
    }
...
private:
    ...
    {
       #if CUTE_EXCEPTIONS_DISABLED
        assert (data != nullptr); // without exceptions, you'll need to find a better way to handle this failure case.
       #else
