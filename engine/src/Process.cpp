...
//}
//
//error_t Process::kill(handle_t handle, int sig)
//{
//#ifdef CUTE_OS_FAMILY_WINDOWS
//	if (handle != NULL)
//	{
...
//	WinConvertToSystem(cmd, cmdLine);
//	WinConvertToSystem(directory, initDir);
//
//	const wchar_t* workingDirectory = initDir.empty() ? 0 : initDir.c_str();
//
//	const char* pEnv = 0;
